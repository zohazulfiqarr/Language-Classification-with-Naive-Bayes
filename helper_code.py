...
st.title('Language Classification with Naive Bayes')


st.text('Enter text to see what language it is in: \n sk stands for Slovak, en for English, and cs for Czech ')

text = st.text_area("Enter a Sentence to check ", "okrem iného ako durič na brlohárenie")
...
r = model.predict(text_vectorized) 
st.text(r)